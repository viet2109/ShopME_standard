						...
						<form method="post"
							...
							<div class="form-group">
								...
								<input style="display: none" type="checkbox" name="show_pass"
									id="show_pass" /> 
									<label for="show_pass" class="show-pass"
									onclick="handleShowPass(this)"> 
										<svg
											xmlns="http://www.w3.org/2000/svg" height="1em"
											viewBox="0 0 576 512">
											<!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
									...
									<label for="show_pass" class="hide-pass"
							...
							<div class="form-group">
								...
								<input onblur="handleOnBlur(this)" onfocus="hanleOnFocus(this)"
									...
									value="<%=re_pass != null ? re_pass : ""%>" /> 
								<input
									style="display: none" type="checkbox" name="show_pass"
									id="show_re_pass" cla /> 
								<label for="show_re_pass" class="show-pass"
									onclick="handleShowPass(this)"> 
									<svg
										xmlns="http://www.w3.org/2000/svg" height="1em"
										viewBox="0 0 576 512">
								...
								<label for="show_re_pass" class="hide-pass"
									onclick="handleShowPass(this)"> <svg
										xmlns="http://www.w3.org/2000/svg" height="1em"
										viewBox="0 0 640 512">
										<!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
							...
							<div class="form-group" style="display: flex; align-items: center; margin-top: 6px">
								<input required type="checkbox" name="agree-term"
									...
									class="label-agree-term" style="margin: 0">
