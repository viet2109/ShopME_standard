...
#show_pass:checked ~.hide-pass {
	display: none !important;
}

#show_pass:not(:checked) ~.show-pass {
	display: none !important;
}

#show_re_pass:checked ~.hide-pass {
	display: none !important;
}

#show_re_pass:not(:checked) ~.show-pass {
	display: none !important;
}
</style>
</head>
<body oncontextmenu='return false' class='snippet-body bg-info'>
							...
							<form class="form-horizontal" action="newPassword" method="POST">
								...
								<div class="form-group row justify-content-center px-3">
									<div class="col-9 px-0">
										<input minlength="6" required="required" type="text"
								...
								<!-- Password Input -->
								<div class="form-group row justify-content-center px-3">
									<div class="col-9 px-0" style="display: relative;">
										<input required="required" type="password" name="confPassword"
											placeholder="&#xf084; &nbsp; Confirm New Password" pattern=""
	...
	<script type="text/javascript">
		$("input[name='confPassword']")[0].oninvalid = function() {
			this
					.setCustomValidity("Confirm password must be as same as password");
		};

		$("input[name='confPassword']")[0].onclick = function() {
			this.setCustomValidity("");
			const passVal = document.querySelector("input[name='password']").value;
			this.setAttribute("pattern", passVal);
		};

		$("input[name='confPassword']")[0].oninput = function() {
			this.setCustomValidity("");
		};
