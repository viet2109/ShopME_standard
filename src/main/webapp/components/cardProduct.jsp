...
<body>
	...
	<div class="col-12 col-md-4 mb-5 mb-md-0" style="padding-bottom: 24px;">
		<a class="product-item"
			...
			<img src="${param.src}" class="img-fluid product-thumbnail">
			<h3 class="product-title" style="text-align: center; text-transform: capitalize;">${param.des }</h3> <strong
			class="product-price">$${param.price }</strong>
		</a>
	</div>
