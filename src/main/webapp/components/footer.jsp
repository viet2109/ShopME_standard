...
<head>
<meta charset="UTF-8">
<link href="${pageContext.servletContext.contextPath}/assets/css/bootstrap.min.css?version=5" rel="stylesheet">
<link
...
<body>
	<footer class="footer-section">
		<div class="container relative">
			...
			<div class="sofa-img">
				<img src="${pageContext.servletContext.contextPath}/assets/images/sofa.png" alt="Image" class="img-fluid">
			</div>
				...
				<div class="col-lg-8">
					<div class="subscription-form">
						<h3 class="d-flex align-items-center">
							<span class="me-1"><img
								src="${pageContext.servletContext.contextPath}/assets/images/envelope-outline.svg" alt="Image"
