			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="sidebarCollapse">
					...
					<ul class="navbar-nav">
						...
						<li class="nav-item"><a class="nav-link" href="${pageContext.servletContext.contextPath}/pages/admin_user.jsp"> <i
								class="bi bi-people"></i> Users
						</a></li>
						<li class="nav-item"><a class="nav-link" href="${pageContext.servletContext.contextPath}/pages/admin_product.jsp">
